            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('profile.show', ['user' => Auth::id()])">
                                {{ __('Profile') }}
                            </x-dropdown-link>
                ...
                @else
                    ...
                    <a href="{{ route('login') }}" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 px-4">
                        {{ __('Login') }}
                    </a>
